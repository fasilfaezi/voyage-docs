...
A reference lookup for every section Voyage ships. The settings count is the number of merchant-facing fields exposed on the section itself; the blocks count is the number of block types the section accepts.
