---
title: "Quick start"
description: "Set up Voyager for your brand in about 10 minutes."
---
...
- Voyager installed on your store ([see Installation](/getting-started/installation))
...
Footer is block-based. By default Voyager ships with:
...
Top-right of the Theme Editor: **Save** (saves draft) → close → go to **Themes** → **⋯** on Voyager → **Publish**.

Your visitors now see your customized Voyager.
