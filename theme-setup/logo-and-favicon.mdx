...
Voyager gives you four logo-related controls — a default logo, a light variant for dark backgrounds, a desktop width, and a favicon. Together they cover every surface where your brand mark appears: the header, the page-transition curtain, the intro loader, and the browser tab.
...
Upload a square image to **Favicon**. Voyager crops it to a `32 × 32` square for the browser tab — anything non-square will be centre-cropped, so design accordingly.
