...
<CardGroup cols={2}>
  <Card title="Change the announcement bar message" href="/sections-reference/announcement-bar">
  ...
  <Card title="Add a footer link column" href="/sections-reference/footer">
  ...
  <Card title="Set the cart type" href="/sections-reference/cart">
