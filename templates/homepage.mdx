---
title: "Homepage"
description: "The six default sections that compose Voyage's home, in the order they appear."
---
...
Voyage's homepage accepts any section that allows the `index` template in its `presets` group. Click **Add section** in the Theme Editor's home view and you'll see:
...
<CardGroup cols={2}>
  <Card title="Hero section" href="/sections-reference/home-hero">
  ...
  <Card title="Sections overview" href="/sections-reference/sections-overview">
    Every section Voyage ships with.
  </Card>
</CardGroup>
