---
title: "Hero & banners"
description: "Home hero, image banner, and slideshow — the three full-bleed hero patterns in Voyage."
---

Voyage ships three hero treatments. They sit at the top of a page and own the first viewport. Pick one per page; they're not designed to stack.
...
<ParamField path="text" type="text" default="Voyage">
  Eyebrow text.
</ParamField>
...
<ParamField path="script_prefix" type="text">
  Optional script word that precedes the main heading (e.g., "The Voyage").
</ParamField>
...
Ships with 4 blocks: eyebrow, heading (`script_prefix: "The Voyage"`, `text: "Summer 2026"`), body, button.
