...
description: "All 47 sections in Voyage, grouped by purpose. Find a section, see its template availability, jump to its reference."
---

Every page in Voyage is a stack of sections. A section is one Liquid file (`sections/*.liquid`) with a JSON schema at the bottom — the schema is what the merchant configures in the Theme Editor. This page is the index. Each section lives in one of ten deep-dive pages, grouped by what it does.
